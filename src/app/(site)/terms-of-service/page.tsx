...
export default function TermsOfServicePage() {
  return <article className="game-info-page">
    ...
    <section className="game-info-section"><h2>Accuracy and availability</h2><p>Game mechanics, patch behavior, pricing, and platform features can change. Gameplay pages distinguish official information from clearly labeled community-tested observations. Check the official game channels and storefronts before relying on purchase or compatibility information.</p><p>We aim to correct errors, but do not guarantee complete, uninterrupted, or error-free content. Nothing here guarantees game performance or particular gameplay outcomes.</p></section>
